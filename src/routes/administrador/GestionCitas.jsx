        ...
        <>
            <div className="rounded-2xl border-azulClaro border-2 justify-center w-[90%] h-[35rem] bg-azulNav lg:ml-8 ml-auto mr-auto mt-5 mb-20 overflow-hidden">
                <div className="flex justify-items-center lg:mb-5 mb-2">
                    <div className="border-2 rounded-2xl bg-morado p-2 lg:mt-5 mt-2 w-full lg:flex grid grid-rows-1 items-center mx-2">
                        <div className='flex'>
        ...
        <>
            <div className="lg:flex justify-center grid grid-rows-2 mt-6">
                <div className=' w-screen'>
                    <p className="font-medium justify-center text-4xl ml-11">Citas solicitadas</p>
                    <ListadoCitas />
                </div>
                <div className=' w-screen'>
                    <p className="font-medium justify-center text-4xl ml-11">Citas aceptadas</p>
                    <Aceptadas />
                </div>
