  ...
  return (
    <div className="flex items-center lg:flex justify-center">
      <div className="w-[40rem] h-[28rem] bg-azulNav rounded-lg border-2 border-azul">
        ...
        <div className="flex">
          <label className="mt-4 w-1/2 border-2 flex justify-center bg-azul text-white text-bold">Corporales</label>
          <label className="mt-4 w-1/2 border-2 flex justify-center bg-azul text-white text-bold">Faciales</label>
        </div>
        <div className="flex">
          <Serv />
        </div>
