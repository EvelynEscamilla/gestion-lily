...
const Programadas = ({Lista}) => {
            ...
            {Lista.map(Lista => (
                ...
                <div className="border-2 cursor-pointer border-azul rounded-2xl bg-white p-2 mt-5 flex items-center mb-2 mr-4 ml-4">
                    <div className="bg-white p-2 flex items-center mr-2">
                        <p className="font-bold text-justify text-lg">{Lista.fecha} | </p>
                    </div>
                    <div className="bg-white p-2 flex items-center mr-2">
                        <p className="font-bold text-justify text-lg">{Lista.hora} | </p>
                    </div>
                    <div className="bg-white p-2 flex items-center mr-2">
                        <p className="font-bold text-justify text-lg">{Lista.servicio}</p>
                    </div>
                </div>
  ...
  const Advertencia = () => {
    ...
    return (
       ...
       <p className="text-4xl">Recuerda que una vez cancelada la cita NO HABRÁ REMBOLSO del anticipo dado</p>
       </div>
  ...
  const CancelarCita = () => {
    return (
        <>
      <Navbar/>
      <div className="flex justify-center w-1/2 ml-8 mt-10"><p className="font-medium justify-center text-4xl">Citas programadas</p></div>
      <div className="flex">
      <CitasP/>
      <Advertencia/>
      </div>
